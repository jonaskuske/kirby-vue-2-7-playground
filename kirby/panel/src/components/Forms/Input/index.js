...
VueGlobalMethods.component("k-checkbox-input", CheckboxInput);
VueGlobalMethods.component("k-checkboxes-input", CheckboxesInput);
VueGlobalMethods.component("k-date-input", DateInput);
VueGlobalMethods.component("k-email-input", EmailInput);
VueGlobalMethods.component("k-list-input", ListInput);
VueGlobalMethods.component("k-multiselect-input", MultiselectInput);
VueGlobalMethods.component("k-number-input", NumberInput);
VueGlobalMethods.component("k-password-input", PasswordInput);
VueGlobalMethods.component("k-radio-input", RadioInput);
VueGlobalMethods.component("k-range-input", RangeInput);
VueGlobalMethods.component("k-select-input", SelectInput);
VueGlobalMethods.component("k-slug-input", SlugInput);
VueGlobalMethods.component("k-tags-input", TagsInput);
VueGlobalMethods.component("k-tel-input", TelInput);
VueGlobalMethods.component("k-text-input", TextInput);
VueGlobalMethods.component("k-textarea-input", TextareaInput);
VueGlobalMethods.component("k-time-input", TimeInput);
VueGlobalMethods.component("k-toggle-input", ToggleInput);
VueGlobalMethods.component("k-toggles-input", TogglesInput);
VueGlobalMethods.component("k-url-input", UrlInput);
